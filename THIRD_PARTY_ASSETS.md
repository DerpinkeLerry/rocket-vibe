...
All assets below were supplied for this project by the user. The original GLB files retain their embedded glTF asset metadata.
...
- Local asset: `src/assets/octane-rocket-league.glb`
...
- License: CC BY 4.0
- License URL: https://creativecommons.org/licenses/by/4.0/
- Local asset: `src/assets/dominus-rocket-league.glb`
