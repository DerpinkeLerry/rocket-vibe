...
- Nach Login oder Gastzugang folgt eine klare Auswahl zwischen Solo und Multiplayer. Multiplayer öffnet weiterhin die öffentliche Lobbyliste; Solo besitzt einen eigenen Match-Konfigurator für Modus, Regeln, Physics-Presets, sämtliche Physikwerte, bis zu drei KI-Mitspieler, bis zu vier KI-Gegner und getrennte Schwierigkeitsgrade. Die deterministischen ROOKIE-, PRO- und ALL-STAR-Bots fahren über normale 120-Hz-Fahrzeuginputs, rotieren zwischen Angriff, Support und Verteidigung, berechnen Ballflug und Schusswinkel und können je nach Stufe boosten, driften, springen und flippen. Solo unterstützt außerdem Matchuhr, Scorelimit und Overtime.
- Liegt ein Auto auf Dach oder Seite am Boden, richtet ein erneuter Sprung es mit einem kurzen kontrollierten Impuls wieder auf seine Räder aus. Solo-KI nutzt diese Recovery auf allen Schwierigkeitsstufen automatisch und hält währenddessen ihre Luftsteuerung kurz neutral. Eine Interpolation zwischen den festen 120-Hz-Physikschritten glättet außerdem Autos, Ball und Verfolgungskamera bei schwankenden Renderframeraten.
- Ein vollständiges prozedurales Sound-Design ergänzt Motorlast, Drehzahl und Gangwechsel, Boost, Fahrtwind, Reifen und Drift, Sprünge, Flips, Landungen, Auto-/Ball-/Arena-Kontakte, kleine und volle Boost-Pads, leeren Boost, Kamerawechsel, Reset, Countdown, die letzten Matchsekunden, Anpfiff, Overtime, Tore, Demolitions, Respawn, Replay, Matchende, Chat und UI. Räumliches Stereo-Panning, Entfernungsdämpfung, Voice-Limits und ein Dynamik-Kompressor halten den Mix klar und mobil-tauglich. Es gibt bewusst keinerlei Musik.
- Der deutlich stärkere mobile Ballkontakt-Assistent berechnet aus Auto- und Ballbewegung einen weit vorausberechneten Kontaktkorridor. Er greift bereits aus größerer Entfernung kräftig in kleine und mittlere Lenkfehler ein, hilft reduziert auch in der Luft und visiert selbst bei seitlichen Anfahrten die Rückseite des Balls relativ zum gegnerischen Tor an. Im mobilen Match-Menü lässt er sich ausschalten; standardmäßig ist er aktiv. Eine nahezu volle bewusste Gegenlenkung bricht den Eingriff weiterhin ab; Ballphysik und Hitboxen bleiben identisch zu Desktop und Multiplayer-Server.
