...
- Der mobile Ballkontakt-Assistent visiert bei einem Abschluss die Rückseite des Balls relativ zum gegnerischen Tor an, bleibt außerhalb des kurzen Schussfensters aber vollständig passiv. Im Schussfenster ergänzt er nur leichtes Untersteuern; Gegenlenken, stärkeres Einlenken, Pässe und bewusst schräge Kontakte behalten sofort Vorrang. Im mobilen Match-Menü lässt er sich ausschalten und ist standardmäßig aktiv; Ballphysik und Hitboxen bleiben identisch zu Desktop und Multiplayer-Server.
